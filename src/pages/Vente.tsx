...
import {
  Search, Plus, Minus, Trash2, ShoppingCart, Check, Printer, X, Package, UserPlus,
} from "lucide-react";
          ...
          {caisseOuverte === false && (
            <div className="flex flex-wrap items-center gap-3 p-4 mb-5 bg-amber-50 border border-amber-200 rounded-lg">
              <p className="text-sm text-amber-900 flex-1 min-w-[240px]">
                La caisse de {libelle} n'est pas ouverte. Ouvrez-la pour pouvoir encaisser : c'est
                elle qui permet de rapprocher les recettes du fond de caisse en fin de journée.
              </p>
              ...
              <div className="lg:sticky lg:top-0 lg:self-start">
                <Card className="flex flex-col max-h-[calc(100vh-8rem)]">
                  <div
                    ...
                    style={courant ? { borderTopColor: courant.couleur, borderTopWidth: 3 } : undefined}
                  >
