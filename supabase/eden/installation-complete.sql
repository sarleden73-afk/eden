-- ============================================================================
-- EDEN MULTI-SERVICES — Installation complète de la base de données
-- ----------------------------------------------------------------------------
-- Fichier généré : concaténation de 01-schema.sql et 02-seed.sql.
-- À coller en une seule fois dans Supabase > SQL Editor > New query, puis Run.
-- Ne s'exécute qu'une fois : le schéma échouerait à la seconde exécution
-- (les types et tables existeraient déjà). Pour recharger uniquement le
-- catalogue, utiliser 02-seed.sql, qui est idempotent.
-- ============================================================================
